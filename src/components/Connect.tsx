...
const Connect: React.FC = () => {
    const LoginSchema = yup.object().shape({
        name: yup.string().min(8, 'Minimum character should be 8').required('Name is required'),
    ...
    return (
        <div className="h-[60vh] md:h-[50vh] flex justify-center mt-12 mx-6">
            <div className="bg-[#9694FF] md:w-[70vw] md:h-[40vh] lg:w-[60vw] items-center rounded-lg flex flex-col md:flex-row">
                <div className="bg-[#231d1d] rounded-lg md:rounded-tr-3xl rounded-br-[4rem] h-44 md:h-full md:w-[40%] flex flex-col justify-center gap-2 p-7">
                ...
                <Form {...form}>
                    <div className="px-8 py-4 w-full">
                        ...
                        <button
                            type="button"
                            className="px-5 py-2 border-2 rounded-3xl mt-3 hover:bg-[#f1f0e878]"
